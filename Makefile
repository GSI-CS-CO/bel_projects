...
pexarria5-clean::
	$(MAKE) -C syn/gsi_pexarria5ls/control PATH=$(PWD)/toolchain/bin:$(PATH) clean

pexarria5ls::	firmware
	$(MAKE) -C syn/gsi_pexarria5ls/control PATH=$(PWD)/toolchain/bin:$(PATH) all
