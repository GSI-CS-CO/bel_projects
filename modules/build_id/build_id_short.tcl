...
lappend output "[lindex $quartus(args) 1]"
lappend output "$platform"
lappend output "[get_global_assignment -name FAMILY] ([get_global_assignment -name DEVICE])"
lappend output "$source_info"
lappend output "$build_type"
lappend output "$build_date"
lappend output "$username <$email>"
lappend output "[info hostname]"
lappend output "$build_os"
