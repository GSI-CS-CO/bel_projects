...
mkdir -p ./libraries/ref_pll10_altera_iopll_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_iopll_160/sim/ref_pll10_altera_iopll_160_d3szf3y.vo" -work ref_pll10_altera_iopll_160 -cdslib ./cds_libs/ref_pll10_altera_iopll_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ref_pll10.vhd"                                                                                                                                       
fi
