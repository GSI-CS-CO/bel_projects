...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_iopll_160/sim/ref_pll10_altera_iopll_160_d3szf3y.vo" -work ref_pll10_altera_iopll_160
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ref_pll10.vhd"                                                                                 
fi
