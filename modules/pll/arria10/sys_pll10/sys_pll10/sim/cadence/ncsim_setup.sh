...
mkdir -p ./libraries/sys_pll10_altera_iopll_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_iopll_160/sim/sys_pll10_altera_iopll_160_pcex3oq.vo" -work sys_pll10_altera_iopll_160 -cdslib ./cds_libs/sys_pll10_altera_iopll_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sys_pll10.vhd"                                                                                                                                       
fi
