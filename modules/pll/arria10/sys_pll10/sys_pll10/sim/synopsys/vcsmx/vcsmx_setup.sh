...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_iopll_160/sim/sys_pll10_altera_iopll_160_pcex3oq.vo" -work sys_pll10_altera_iopll_160
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sys_pll10.vhd"                                                                                 
fi
