...
mkdir -p ./libraries/dmtd_pll10_altera_iopll_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../altera_iopll_160/sim/dmtd_pll10_altera_iopll_160_fd67bvy.vo" -work dmtd_pll10_altera_iopll_160 -cdslib ./cds_libs/dmtd_pll10_altera_iopll_160.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dmtd_pll10.vhd"                                                                                                                                         
fi
