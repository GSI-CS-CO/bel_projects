...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/../altera_iopll_160/sim/dmtd_pll10_altera_iopll_160_fd67bvy.vo" -work dmtd_pll10_altera_iopll_160
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dmtd_pll10.vhd"                                                                                  
fi
