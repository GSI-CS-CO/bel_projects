...
mkdir -p ./libraries/dmtd_pll10_altera_iopll_181/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_181/sim/dmtd_pll10_altera_iopll_181_l6e2jjy.vo" -work dmtd_pll10_altera_iopll_181 -cdslib ./cds_libs/dmtd_pll10_altera_iopll_181.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dmtd_pll10.v"                                                                                                                                           
fi
