...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_181/sim/sys_pll10_altera_iopll_181_j3py53y.vo" -work sys_pll10_altera_iopll_181 -cdslib ./cds_libs/sys_pll10_altera_iopll_181.cds.lib
