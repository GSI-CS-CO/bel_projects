...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/twentynm_xcvr_avmm.sv"          -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/alt_xcvr_resync.sv"             -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/altera_xcvr_fpll_a10.sv"        -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/a10_avmm_h.sv"                  -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/alt_xcvr_native_avmm_nf.sv"     -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/alt_xcvr_pll_embedded_debug.sv" -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_xcvr_fpll_a10_181/sim/alt_xcvr_pll_avmm_csr.sv"       -work sys_fpll10_scu4_altera_xcvr_fpll_a10_181
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/sys_fpll10_scu4.v"                                                                                            
fi
