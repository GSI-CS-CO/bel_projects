...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_181/sim/dmtd_pll10_altera_iopll_181_5laf3ga.vo" -work dmtd_pll10_altera_iopll_181 -cdslib ./cds_libs/dmtd_pll10_altera_iopll_181.cds.lib
