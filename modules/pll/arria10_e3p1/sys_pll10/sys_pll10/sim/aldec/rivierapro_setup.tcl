...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_181/sim/sys_pll10_altera_iopll_181_wfdplty.vo" -work sys_pll10_altera_iopll_181
