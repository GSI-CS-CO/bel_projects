...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_181/sim/ref_pll10_altera_iopll_181_c5qxdni.vo" -work ref_pll10_altera_iopll_181 -cdslib ./cds_libs/ref_pll10_altera_iopll_181.cds.lib
