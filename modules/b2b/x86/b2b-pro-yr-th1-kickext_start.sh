...
echo -e B2B start script for CRYRING extraction kicker room
...
saft-ecpu-ctl $SDTRIG -c  0x10d2804000000000 0xfffffff000000000 20000 0x804 -d -g

echo -e b2b: configure outputs
# generate pulse upon CMD_B2B_TRIGGEREXT
saft-io-ctl $SDTRIG -n IO3 -o 1 -t 0 -a 1
saft-io-ctl $SDTRIG -n IO3 -c 0x10d2804000000000 0xfffffff000000000 0 0x0 1 -u
saft-io-ctl $SDTRIG -n IO3 -c 0x10d2804000000000 0xfffffff000000000 1000 0x0 0 -u 
