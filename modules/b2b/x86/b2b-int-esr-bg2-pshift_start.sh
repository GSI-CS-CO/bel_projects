...
echo -e B2B start script for ESR rf room, phase shift,  INT
###########################################
# clean up stuff
###########################################
...
saft-wbm-ctl $SDPS -c 0x13a580a000000000 0xfffffff000000000 40000 1 -dg
saft-wbm-ctl $SDPS -r 1 $DDSSHIFTPHAS 0 0x5c
# shift value high bits: 0xdddd
saft-wbm-ctl $SDPS -c 0x13a580a000000000 0xfffffff000000000 30000 2 -dg 
saft-wbm-ctl $SDPS -r 2 $DDSSHIFTPHAS 0 0x53
# shift time low bits: 0xbbbb
saft-wbm-ctl $SDPS -c 0x13a580a000000000 0xfffffff000000000 20000 3 -dg
saft-wbm-ctl $SDPS -r 3 $DDSSHIFTTIME 0 0x4c
# shift time high bits: 0xaaaa
saft-wbm-ctl $SDPS -c 0x13a580a000000000 0xfffffff000000000 10000 4 -dg
saft-wbm-ctl $SDPS -r 4 $DDSSHIFTTIME 0 0x43
# start phase shift, EvtID 0x...........1....
saft-wbm-ctl $SDPS -c 0x13a580a000000000 0xfffffff000000000     0 5 -d
saft-wbm-ctl $SDPS -r 5 $DDSSHIFTSTRT - 0x3c
# mode B2B_MODE_B2BPSHIFTE
saft-wbm-ctl $SDPS -c 0x13a680a000000000 0xfffffff000000000 40000 6 -dg
saft-wbm-ctl $SDPS -r 6 $DDSSHIFTPHAS 0 0x5c
# shift value high bits: 0xdddd
saft-wbm-ctl $SDPS -c 0x13a680a000000000 0xfffffff000000000 30000 7 -dg 
saft-wbm-ctl $SDPS -r 7 $DDSSHIFTPHAS 0 0x53
# shift time low bits: 0xbbbb
saft-wbm-ctl $SDPS -c 0x13a680a000000000 0xfffffff000000000 20000 8 -dg
saft-wbm-ctl $SDPS -r 8 $DDSSHIFTTIME 0 0x4c
# shift time high bits: 0xaaaa
saft-wbm-ctl $SDPS -c 0x13a680a000000000 0xfffffff000000000 10000 9 -dg
saft-wbm-ctl $SDPS -r 9 $DDSSHIFTTIME 0 0x43
# start phase shift, EvtID 0x...........1....
saft-wbm-ctl $SDPS -c 0x13a680a000000000 0xfffffff000000000     0 10 -d
...
saft-wbm-ctl tr0 -c 0x1154159000000000  0xfffffff000000000 10000 11 -dg
