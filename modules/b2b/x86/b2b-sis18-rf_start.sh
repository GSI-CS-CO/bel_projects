...
saft-ecpu-ctl $SDCBU -c 0x13a0802000000000 0xfffffff000000000 450000 0x802 -dg
saft-ecpu-ctl $SDCBU -c 0x13a1802000000000 0xfffffff000000000 450000 0x802 -dg

# lm32 listens to CMD_B2B_PRINJ message from injection machine, only required for B2B -> later
saft-ecpu-ctl $SDCBU -c 0x13a1803000000000 0xfffffff000000000 450000 0x803 -dg
