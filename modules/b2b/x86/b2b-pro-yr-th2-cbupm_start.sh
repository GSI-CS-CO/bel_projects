...
echo -e B2B start script for CRYRING rf room
...
#saft-io-ctl $SDPM -n IO1 -c 0x10d2805000000000 0xfffffff000000000 0 0x0 1 -u
#saft-io-ctl $SDPM -n IO1 -c 0x10d2805000000000 0xfffffff000000000 10000000 0x0 0 -u

# diag: generate pulse upon CMD_B2B_TRIGGEREXT message from CRYRING CBU
saft-io-ctl $SDPM -n IO2 -o 1 -t 0
saft-io-ctl $SDPM -n IO2 -c 0x10d2804000000000 0xfffffff000000000 0 0x0 1 -u
saft-io-ctl $SDPM -n IO2 -c 0x10d2804000000000 0xfffffff000000000 10000000 0x0 0 -u
...
saft-ecpu-ctl $SDCBU -c 0x10d281f000000000 0xfffffff000000000 0 0x81f -d

# lm32 listens to CMD_B2B_PREXT message from extraction machine, 250us pretrigger
saft-ecpu-ctl $SDCBU -c 0x13aa802000000000 0xfffffff000000000 250000 0x802 -dg
...
#saft-io-ctl $SDCBU -n IO1 -c 0x10d281f000000000 0xfffffff000000000 0 0x0 1 -u
#saft-io-ctl $SDCBU -n IO1 -c 0x10d281f000000000 0xfffffff000000000 10000000 0x0 0 -u
