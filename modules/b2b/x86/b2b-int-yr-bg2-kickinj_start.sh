...
# generate test pulses upon CMD_B2B_TRIGGERINJ for INT(!), only for 'kicker electronics'
saft-io-ctl $SDTRIGTEST -n IO2 -o 1 -t 0 -a 1
saft-io-ctl $SDTRIGTEST -n IO2 -c 0x10d2805000000000 0xfffffff000000000 2420 0x0 1 -u
saft-io-ctl $SDTRIGTEST -n IO2 -c 0x10d2805000000000 0xfffffff000000000 2620 0x0 0 -u
