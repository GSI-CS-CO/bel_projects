 ...
 ********************************************************************************************/
#define B2BPMSTUB_FW_VERSION 0x000702                                   // make this consistent with makefile
  ...
  switch (ecaAction) {
    ...
    case B2B_ECADO_B2B_PMINJ :
      ...
      *pSharedGetSid   = recSid;
      ...
      sendParam    = tH1_125ps;
      sendDeadline = recDeadline + (uint64_t)B2B_AHEADT;              // use a more aggressive deadline < COMMON_AHEADT
    ...
    case B2B_ECADO_B2B_PDINJ :
      if (!sendEvtNo) 
        ...
        sendDeadline = recDeadline + (uint64_t)COMMON_AHEADT;        // use the more conservativ deadline
        fwlib_ebmWriteTM(sendDeadline, sendEvtId, sendParam, 0, 0);
