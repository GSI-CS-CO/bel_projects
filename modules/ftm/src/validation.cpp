...
void init() {
        ...
        cRules.insert(ConstellationRule(n::sBlockFixed,  e::sRef,         cNonMeta,  0, MaxOccurrance::REF  ));
        ...
        cRules.insert(ConstellationRule(n::sBlockAlign,  e::sRef,         cNonMeta,  0, MaxOccurrance::REF  ));
