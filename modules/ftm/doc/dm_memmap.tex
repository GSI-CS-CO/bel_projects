...
\begin{figure}[H]
  ...
  \begin{bytefield}{32}
    \bitheader{31,0}\\
    \colorwordbox{lightyellow}{2}{Time Offset to Block Start (\SI{}{\nano\second})}\\
    \colorwordbox{lightyellow}{1}{Ptr to Thread Origin Node}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightyellow}{1}{CPU Idx}\\
    \colorwordbox{lightyellow}{1}{Thread Idx}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
  ...
  \end{rightwordgroup}\\
    \colorwordbox{lightyellow}{1}{Next Ptr}\\
\end{bytefield}
  \caption{Origin Memory Layout}
  \label{fig:Origin-Memory-Layout}
\end{figure}
\noindent
...
\begin{figure}[H]
  ...
  \begin{bytefield}{32}
    \bitheader{31,0}\\
    \colorwordbox{lightyellow}{2}{Time Offset to Block Start (\SI{}{\nano\second})}\\
    \colorwordbox{lightyellow}{2}{Start Time Offset to Block Start (\SI{}{\nano\second}) Abs time passed to Thread}\\
    \colorwordbox{lightyellow}{1}{CPU Idx}\\
    \colorwordbox{lightyellow}{1}{Thread Idx}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
  ...
  \end{rightwordgroup}\\
    \colorwordbox{lightyellow}{1}{Next Ptr}\\
\end{bytefield}
  \caption{Startthread Memory Layout}
  \label{fig:Startthread-Memory-Layout}
\end{figure}
\noindent
...
\begin{figure}[H]
  \begin{bytefield}{32}
    ...
    \colorwordbox{lightyellow}{2}{Time Offset to Block Start (\SI{}{\nano\second})}\\
    \colorwordbox{lightyellow}{1}{Ptr to Target Block}\\
    \colorwordbox{lightgray}{2}{}\\
    \bitheader{23,20} \\
    \begin{rightwordgroup}{Cmd Action}
      \colorbitbox{lightgray}{8}{}  & \colorbitbox{lightyellow}{4}{\tiny Type} & \colorbitbox{lightgray}{20}{}
  \end{rightwordgroup}\\
    \colorwordbox{lightyellow}{1}{Ptr to Switch Destination}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightgray}{1}{}\\
    \colorwordbox{lightblue}{1}{Hash of Node Name}\\
  ...
  \end{rightwordgroup}\\
    \colorwordbox{lightyellow}{1}{Next Ptr}\\
\end{bytefield}
  \caption{Switch Command Memory Layout}
  \label{fig:Switch-Command-Memory-Layout}
\end{figure}
\noindent
