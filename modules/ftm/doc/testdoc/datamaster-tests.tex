...
which has three pattern (MAIN, A, B).
    \begin{figure}
        \centering
        \includegraphics*[width=1.2\textwidth,keepaspectratio]{TestPattern/booster_startthread-0-s.pdf}
...
which has one pattern MAIN.
    \begin{figure}
        \centering
        \includegraphics*[width=1.2\textwidth,keepaspectratio]{TestPattern/booster_all_threads-s.pdf}
        \caption{Schedule for test of origin and startthread}
...
which has one pattern MAIN.
    \begin{figure}
        \centering
        \includegraphics*[width=1.2\textwidth,keepaspectratio]{TestPattern/booster_thread_0_loop-s.pdf}
        \caption{Schedule for test of origin and startthread}
...
which has one pattern MAIN.
    \begin{figure}
        \centering
        \includegraphics*[width=1.2\textwidth,keepaspectratio]{TestPattern/booster_thread_0-s.pdf}
        \caption{Schedule for test of origin and startthread}
        \label{fig:Schedule_booster_thread_0}
    \end{figure}
\end{enumerate}
% booster_all_threads.dot      booster_startthread-2-s.dot  booster_startthread-s.dot    booster_thread_0_loop-s.dot  
% booster_startthread-1-s.dot  booster_startthread-3-s.dot  booster_startthread-s.pdf    booster_thread_0-s.dot       
