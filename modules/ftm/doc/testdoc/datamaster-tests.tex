...
Use schedule \texttt{booster-thread-0.dot} \\
...
are used from the build of the test repository in folders \texttt{modules/ftm/bin}
and \texttt{modules/ftm/lib}. This is configured in the Makefile.
\item setUp(self)
