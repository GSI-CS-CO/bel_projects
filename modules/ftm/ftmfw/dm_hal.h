 ...
 */
//@{
uint8_t halInitCpuId(void); ///< Initializes cpuID hardware (real, mock_lm32: find_device_adr(GSI, CPU_INFO_ROM); mock_x86: returns 1)
//@}
...
/** @name Mock specific actions
 */
//@{
void halOnlyMockDoesStuff(void); ///< Performs mock-specific actions (no-op on real HAL)
//@}
