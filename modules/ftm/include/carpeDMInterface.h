#ifndef _CARPEDM_INTERFACE_H_
#define _CARPEDM_INTERFACE_H_
...
private:
  ...
  class CarpeDM;
  std::unique_ptr<CarpeDM> impl_;

public:
  CarpeDMInterface();                                      
  CarpeDMInterface(std::ostream& sLog);                    
  CarpeDMInterface(std::ostream& sLog, std::ostream& sErr);
  ~CarpeDMInterface();
