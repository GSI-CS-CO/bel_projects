...
class HexTests(dm_testbench.DmTestbench):
  ...
  def testHexdumpTarget(self):
    ...
    'dm-cmd hex Block3a_ListDst_0' with the expected lines.
    """
    ...
    expectedLinesBlock3a_ListDst_0=[
      "Block3a_ListDst_0:",
      "  0000  10 00 0b 08 00 00 00 00 00 00 00 00 00 00 00 00  ................",
      "  0010  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................",
      "  0020  00 00 00 00 00 00 00 00 17 b1 0d 8f 00 00 00 0c  ................",
      "  0030  10 00 09 68"
    ]
    if self.threadQuantity == 32:
      expectedLinesBlock3a_ListDst_0[1] = "  0000  10 00 11 08 00 00 00 00 00 00 00 00 00 00 00 00  ................"
      expectedLinesBlock3a_ListDst_0[4] = "  0030  10 00 0f 68"
    ...
    lines = self.startAndGetSubprocessOutput((self.binaryDmCmd, self.datamaster, 'hex', 'Block3a_ListDst_0'), [0], 5, 0)
    for i in range(len(lines[0])):
      self.assertEqual(expectedLinesBlock3a_ListDst_0[i], lines[0][i])
