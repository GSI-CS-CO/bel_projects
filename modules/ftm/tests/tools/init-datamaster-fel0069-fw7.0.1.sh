...
~/bel_projects/dev/syn/gsi_pexarria5/ftm/fwload_all.sh tcp/fel0069.acc.gsi.de ~/Documents/fel0069/ftm_v7.0.1.bin
# Test that the tools version and the firmware version are compatible
~/bel_projects/modules/ftm/bin/dm-cmd tcp/fel0069.acc.gsi.de
OPTIONS='-k zzz' make -C ~/bel_projects/release/modules/ftm/tests remote
