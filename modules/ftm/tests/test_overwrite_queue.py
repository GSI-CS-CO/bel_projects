...
class OverwriteBlocks(dm_testbench.DmTestbench):
  ...
  def actionOverwriteSchedules(self):
    ...
    self.startAndCheckSubprocess((self.binaryDmCmd, self.datamaster, 'startpattern', 'PPS_NONE'), linesCout=1, linesCerr=0)
    self.delay(2.5)
    ...
    self.delay(0.1)
    self.startAndCheckSubprocess((self.binaryDmCmd, self.datamaster, 'startpattern', 'PPS_QLO'), linesCout=1, linesCerr=0)
    self.delay(2.5)
    self.startAndCheckSubprocess((self.binaryDmCmd, self.datamaster, 'stoppattern', 'PPS_QLO'), linesCout=0, linesCerr=0)
    ...
    self.delay(0.1)
    self.startAndCheckSubprocess((self.binaryDmCmd, self.datamaster, 'startpattern', 'PPS_QHI'), linesCout=1, linesCerr=0)
    self.delay(2.5)
    self.startAndCheckSubprocess((self.binaryDmCmd, self.datamaster, 'stoppattern', 'PPS_QHI'), linesCout=0, linesCerr=0)
  ...
  def test_overwriteSchedules(self):
    ...
    self.snoopToCsvWithAction(fileName, self.actionOverwriteSchedules, duration=10)
