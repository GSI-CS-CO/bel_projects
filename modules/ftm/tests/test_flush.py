...
class UnitTestFlush(dm_testbench.DmTestbench):
  ...
  def test_flow_flushNone_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush0_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush1_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush2_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flushNone_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio1'), [0])
    self.delay(0.2)
  ...
  def test_flow_flush0_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush1_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio1'), [0])
    self.delay(0.2)
  ...
  def test_flow_flush2_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flushNone_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queueNone-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush0_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue0-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush1_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue1-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush2_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue2-prio2'), [0])
    self.delay(0.2)
  ...
  def test_flow_flush01_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush02_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush12_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush123_prio0(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio0'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio0'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush01_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush02_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush12_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush123_prio1(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio1'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio1'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush01_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue01-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush02_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue02-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush12_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue12-prio2'), [0])
    self.delay(0.1)
  ...
  def test_flow_flush123_prio2(self):
    ...
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio2'), [0])
    self.startAndCheckSubprocess((self.binary_dm_cmd, self.datamaster, 'startpattern', 'P-queue123-prio2'), [0])
    self.delay(0.1)
