...
class TestIsomorphisms(common_scheduleCompare.CommonScheduleCompare):
  ...
  def test_six_isomorphisms(self):
    ...
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x3.dot', expectedReturnCode=1, linesCerr=0, linesCout=1)

  def test_six_isomorphisms_n(self):
    """Compare a cycle of length 3 with a schedule of 4 vertices and 5 edges.
    There are 6 isomorphisms.
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x3.dot', '-n', expectedReturnCode=2, linesCerr=0, linesCout=8)
  ...
  def test_six_isomorphisms_silent(self):
    ...
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x3.dot', '-s', expectedReturnCode=1, linesCerr=0, linesCout=0)

  def test_six_isomorphisms_silent_n(self):
    """Compare a cycle of length 3 with a schedule of 4 vertices and 5 edges.
    There are 6 isomorphisms. Test with silent (-s) option.
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x3.dot', '-sn', expectedReturnCode=2, linesCerr=0, linesCout=0)
  ...
  def test_three_isomorphisms(self):
    ...
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x0.dot', expectedReturnCode=0, linesCerr=0, linesCout=3)

  def test_three_isomorphisms_n(self):
    """Compare a cycle of length 3 with itself.
    There are 3 isomorphisms.
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x0.dot', '-n', expectedReturnCode=0, linesCerr=0, linesCout=5)
  ...
  def test_nine_isomorphisms_n(self):
    ...
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x1.dot', '-n', expectedReturnCode=2, linesCerr=0, linesCout=11)
  ...
  def test_three_isomorphisms_different_names(self):
    ...
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x2.dot', expectedReturnCode=1, linesCerr=0, linesCout=1)

  def test_three_isomorphisms_different_names_n(self):
    """Compare a cycle of length 3 with another cycle of length 3.
    There are 3 isomorphisms.
    """
    self.callScheduleCompare('permutations/x0.dot', 'permutations/x2.dot', '-n', expectedReturnCode=0, linesCerr=0, linesCout=5)
