...
#define  B2BTEST_AHEADT           500000      // ahead interval for sending timing messages [ns]
...
#define  B2BTEST_ECADO_B2B_SYNCEXT    2053    // command: sync trigger (extraction)
#define  B2BTEST_ECADO_B2B_SYNCINJ    2054    // command: sync trigger (injeciton)
...
#define B2BTEST_SHARED_DATA_4EB       (B2BTEST_SHARED_TH1INJLO   + _32b_SIZE_)          // shared area for EB return values
