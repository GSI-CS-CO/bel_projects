...
COMMAND_OFFSET=0x0          #  0x0   is the address of command word counting from start of shared segment
SOURCE_OFFSET=0x10          #  0x10  is the address of the event source register (has to be written 1 (SIS) or 2 (ESR))
