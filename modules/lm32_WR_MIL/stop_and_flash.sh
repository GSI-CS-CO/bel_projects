...
SHARED_SEGMENT_OFFSET=500 # 500 is relative start of shared segment
COMMAND_OFFSET=8          #   8 is the address of command word counting from start of shared segment
...
CMD_ADR=`expr $BASE_ADR + $SHARED_SEGMENT_OFFSET + $COMMAND_OFFSET` 
