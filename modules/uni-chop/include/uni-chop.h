...
#define UNICHOP_ECADO_MIL_WRITE            0xfa6   // timing message received from host; writes data to MIL : 32..39 ifb addr, 24..31 mod addr, 16..23: reg addr, 0..15 data
#define UNICHOP_ECADO_MIL_READ             0xfa7   // timing message received from host; reads data from MIL: 32..39 ifb addr, 24..31 mod addr, 16..23: reg addr, 0..15 reserved
...
#define UNICHOP_ECADO_DIAG_MIL_READ        0xfab   // diagnostic timing message sent by firmware after UNICHOP_ECADO_MIL_READ; param 0..15: data
