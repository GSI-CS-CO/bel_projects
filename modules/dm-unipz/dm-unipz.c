...
//Should include the first autogenerated h-file in the second handmade h-file and remove it here. You need them together anyway
...
//why no Array access ? One pointer plus offset or index is sufficient!
...
void initLocalPPSGen(){
  ...
  // strange name ... this doesn't do what it says on the box!
...
void initMILDevicebus(){
  // Again - strange name ... this doesn't do what it says on the box!
...
void main(void) {
  ...
  // these unions are is not used anywhere else - what are they supposed to do??
