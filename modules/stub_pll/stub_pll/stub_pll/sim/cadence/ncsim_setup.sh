...
mkdir -p ./libraries/stub_pll_altera_iopll_181/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../altera_iopll_181/sim/stub_pll_altera_iopll_181_arpnjwy.vo" -work stub_pll_altera_iopll_181 -cdslib ./cds_libs/stub_pll_altera_iopll_181.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/stub_pll.v"                                                                                                                                       
fi
