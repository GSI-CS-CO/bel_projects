...
# ACDS 13.1 162 linux 2014.10.31.16:21:51
...
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/alex/workspace/optional/quartus/altera/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/arriav_atoms_ncrypt.v"   -work arriav      
  vhdlan                "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriav_atoms.vhd"                 -work arriav      
  vhdlan                "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriav_components.vhd"            -work arriav      
fi

# ----------------------------------------
# compile design files in correct order
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm "$QSYS_SIMDIR/audio_pll.vho"
fi
