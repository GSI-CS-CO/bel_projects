...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvlog      "$QUARTUS_INSTALL_DIR/eda/sim_lib/cadence/arriav_atoms_ncrypt.v"    -work arriav      
  ncvhdl -v93 "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriav_atoms.vhd"                 -work arriav      
  ncvhdl -v93 "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriav_components.vhd"            -work arriav      
fi

# ----------------------------------------
# compile design files in correct order
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 "$QSYS_SIMDIR/audio_pll.vho"
fi
