...
export NGW=3                 # of GW; pzu_qr, pzu_ql ...
export SIDGW=270             # SID of puz_qr, pzu_ql ... (new reference groups, may 2025)
...
sleep 2
wrmil-ctl $TRGW -s$NGW -w$MILDEV -m2 -l0 -t255 -d650 -u56 -f configure
sleep 2
