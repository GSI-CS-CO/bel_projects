...
# './buildApp.sh $HOME/consoleApps/wr-mil wrmil-int-sys-mon wrmil-client-sys'
# './buildApp.sh $HOME/consoleApps/wr-mil wrmil-pro-sys-mon wrmil-client-sys'

SW=../x86
USRPATH=/common/usr/timing/wrmil/centos7
