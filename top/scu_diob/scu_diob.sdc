...
create_generated_clock -name {diob_clk_switch|local_clk|altpll_component|auto_generated|pll1|clk[0]} -source {diob_clk_switch|local_clk|altpll_component|auto_generated|pll1|inclk[0]} -divide_by 10 -multiply_by 1 -duty_cycle 50.00 { diob_clk_switch|local_clk|altpll_component|auto_generated|pll1|clk[0] }
