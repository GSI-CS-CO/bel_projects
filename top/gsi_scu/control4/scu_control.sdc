...
set_clock_groups -asynchronous                                    \
 ...
 -group { main|\pcie_y:pcie|pcie_phy|\arria10gx_scu4:hip|pcie_a10_hip_0|coreclkout}
...
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_scu4:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
...
set_false_path -from [get_clocks {main|\phy_a10_scu4:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}] -to [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk0}]
# cut: pcie <=> wb sys
...
set_false_path -from [get_clocks {main|\pcie_y:pcie|pcie_phy|\arria10gx_scu4:hip|pcie_a10_hip_0|coreclkout}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}]
# cut: wb sys <=> butis
