...
typedef enum
{
   ...
   DAQ_OP_RESET                   = DAQ_OP_OFFSET +  2,
   DAQ_OP_GET_MACRO_VERSION       = DAQ_OP_OFFSET +  3,
   ...
   DAQ_OP_PM_HIRES_OFF            = DAQ_OP_OFFSET +  9,
   DAQ_OP_CONTINUE_ON             = DAQ_OP_OFFSET + 10,
   DAQ_OP_CONTINUE_OFF            = DAQ_OP_OFFSET + 11,
   DAQ_OP_SET_TRIGGER_CONDITION   = DAQ_OP_OFFSET + 12,
   DAQ_OP_GET_TRIGGER_CONDITION   = DAQ_OP_OFFSET + 13,
   DAQ_OP_SET_TRIGGER_DELAY       = DAQ_OP_OFFSET + 14,
   DAQ_OP_GET_TRIGGER_DELAY       = DAQ_OP_OFFSET + 15,
   DAQ_OP_SET_TRIGGER_MODE        = DAQ_OP_OFFSET + 16,
   DAQ_OP_GET_TRIGGER_MODE        = DAQ_OP_OFFSET + 17,
   DAQ_OP_SET_TRIGGER_SOURCE_CON  = DAQ_OP_OFFSET + 18,
   DAQ_OP_GET_TRIGGER_SOURCE_CON  = DAQ_OP_OFFSET + 19,
   DAQ_OP_SET_TRIGGER_SOURCE_HIR  = DAQ_OP_OFFSET + 20,
   DAQ_OP_GET_TRIGGER_SOURCE_HIR  = DAQ_OP_OFFSET + 21
