...
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}] -to [get_clocks {main|\dmtd_a10:dmtd_inst|iopll_0|outclk0}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}] -to [get_clocks {main|\dmtd_a10:dmtd_inst|iopll_0|outclk0}]
# cut ref and sys
...
# cut sys and phy
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}]
set_false_path -from [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}] -to [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}]
# cut phy and sys
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\sys_a10:sys_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
# cut phy and ref
set_false_path -from [get_clocks {main|\ref_a10:sys_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk4}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk5}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|rx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk3}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk4}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_pma_clk}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk0}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk1}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk2}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk3}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
set_false_path -from [get_clocks {main|\ref_a10:ref_inst|iopll_0|outclk4}] -to [get_clocks {main|\phy_a10_e3p1:phy|inst_phy|xcvr_native_a10_0|tx_coreclkin}]
# cut sys and pcie
