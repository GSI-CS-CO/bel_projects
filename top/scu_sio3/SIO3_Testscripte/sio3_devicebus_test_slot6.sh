...
eb-write $scuname 0x4c0804/2 0x1000
echo "read status and control register 0x4c0804"
eb-read  $scuname 0x4c0804/2
echo "--------------------------------------------------"

echo ""
data=0x5a5a
echo "write data "$data" to data register 0x4c0800"
eb-write $scuname 0x4c0800/2 $data



echo ""
echo "write function code 13 and ifk address 79 to command register 0x4c0802"
eb-write $scuname 0x4c0802/2 0x1379


echo "write function code 89 and ifk address 79 to command register 0x4c0802"
eb-write $scuname 0x4c0802/2 0x8979


echo "read of echo-ed word at command register 0x4c0802"
eb-read  $scuname 0x4c0802/2
